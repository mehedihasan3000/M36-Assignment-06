        ...
        <div className='container mx-auto mt-28'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 my-10'>
                ...
                <div className='card bg-base-100 shadow-md px-5 py-20 space-y-4 items-center justify-center relative'>
                    ...
                    <div className='bg-purple-100 rounded-full p-5'><img src="/public/user.png" alt="" /></div>
                ...
                <div className='card bg-base-100 shadow-md px-5 py-20 space-y-4 items-center justify-center relative'>
                    ...
                    <div className='bg-purple-100 rounded-full p-5'><img src="/public/package.png" alt="" /></div>
                ...
                <div className='card bg-base-100 shadow-md px-5 py-20 space-y-4 items-center justify-center relative'>
                    ...
                    <div className='bg-purple-100 rounded-full p-5'><img src="/public/rocket.png" alt="" /></div>
